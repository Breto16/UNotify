USE [master]
GO
/****** Object:  Database [UNotify3.8]    Script Date: 14/9/2023 03:19:09 ******/
CREATE DATABASE [UNotify3.8]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'UNotify3.8', FILENAME = N'D:\Programas\SQL Serv\MSSQL16.MSSQLSERVER\MSSQL\DATA\UNotify3.8.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'UNotify3.8_log', FILENAME = N'D:\Programas\SQL Serv\MSSQL16.MSSQLSERVER\MSSQL\DATA\UNotify3.8_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
 WITH CATALOG_COLLATION = DATABASE_DEFAULT, LEDGER = OFF
GO
ALTER DATABASE [UNotify3.8] SET COMPATIBILITY_LEVEL = 160
GO
IF (1 = FULLTEXTSERVICEPROPERTY('IsFullTextInstalled'))
begin
EXEC [UNotify3.8].[dbo].[sp_fulltext_database] @action = 'enable'
end
GO
ALTER DATABASE [UNotify3.8] SET ANSI_NULL_DEFAULT OFF 
GO
ALTER DATABASE [UNotify3.8] SET ANSI_NULLS OFF 
GO
ALTER DATABASE [UNotify3.8] SET ANSI_PADDING OFF 
GO
ALTER DATABASE [UNotify3.8] SET ANSI_WARNINGS OFF 
GO
ALTER DATABASE [UNotify3.8] SET ARITHABORT OFF 
GO
ALTER DATABASE [UNotify3.8] SET AUTO_CLOSE OFF 
GO
ALTER DATABASE [UNotify3.8] SET AUTO_SHRINK OFF 
GO
ALTER DATABASE [UNotify3.8] SET AUTO_UPDATE_STATISTICS ON 
GO
ALTER DATABASE [UNotify3.8] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO
ALTER DATABASE [UNotify3.8] SET CURSOR_DEFAULT  GLOBAL 
GO
ALTER DATABASE [UNotify3.8] SET CONCAT_NULL_YIELDS_NULL OFF 
GO
ALTER DATABASE [UNotify3.8] SET NUMERIC_ROUNDABORT OFF 
GO
ALTER DATABASE [UNotify3.8] SET QUOTED_IDENTIFIER OFF 
GO
ALTER DATABASE [UNotify3.8] SET RECURSIVE_TRIGGERS OFF 
GO
ALTER DATABASE [UNotify3.8] SET  DISABLE_BROKER 
GO
ALTER DATABASE [UNotify3.8] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO
ALTER DATABASE [UNotify3.8] SET DATE_CORRELATION_OPTIMIZATION OFF 
GO
ALTER DATABASE [UNotify3.8] SET TRUSTWORTHY OFF 
GO
ALTER DATABASE [UNotify3.8] SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO
ALTER DATABASE [UNotify3.8] SET PARAMETERIZATION SIMPLE 
GO
ALTER DATABASE [UNotify3.8] SET READ_COMMITTED_SNAPSHOT OFF 
GO
ALTER DATABASE [UNotify3.8] SET HONOR_BROKER_PRIORITY OFF 
GO
ALTER DATABASE [UNotify3.8] SET RECOVERY FULL 
GO
ALTER DATABASE [UNotify3.8] SET  MULTI_USER 
GO
ALTER DATABASE [UNotify3.8] SET PAGE_VERIFY CHECKSUM  
GO
ALTER DATABASE [UNotify3.8] SET DB_CHAINING OFF 
GO
ALTER DATABASE [UNotify3.8] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO
ALTER DATABASE [UNotify3.8] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO
ALTER DATABASE [UNotify3.8] SET DELAYED_DURABILITY = DISABLED 
GO
ALTER DATABASE [UNotify3.8] SET ACCELERATED_DATABASE_RECOVERY = OFF  
GO
EXEC sys.sp_db_vardecimal_storage_format N'UNotify3.8', N'ON'
GO
ALTER DATABASE [UNotify3.8] SET QUERY_STORE = ON
GO
ALTER DATABASE [UNotify3.8] SET QUERY_STORE (OPERATION_MODE = READ_WRITE, CLEANUP_POLICY = (STALE_QUERY_THRESHOLD_DAYS = 30), DATA_FLUSH_INTERVAL_SECONDS = 900, INTERVAL_LENGTH_MINUTES = 60, MAX_STORAGE_SIZE_MB = 1000, QUERY_CAPTURE_MODE = AUTO, SIZE_BASED_CLEANUP_MODE = AUTO, MAX_PLANS_PER_QUERY = 200, WAIT_STATS_CAPTURE_MODE = ON)
GO
USE [UNotify3.8]
GO
/****** Object:  Table [dbo].[Actividades]    Script Date: 14/9/2023 03:19:09 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Asociaciones]    Script Date: 14/9/2023 03:19:09 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ColaboradoresEventos]    Script Date: 14/9/2023 03:19:09 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Estudiantes]    Script Date: 14/9/2023 03:19:09 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Eventos]    Script Date: 14/9/2023 03:19:09 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Inscripciones]    Script Date: 14/9/2023 03:19:09 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Mensajes]    Script Date: 14/9/2023 03:19:09 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Notificaciones]    Script Date: 14/9/2023 03:19:09 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Propuestas]    Script Date: 14/9/2023 03:19:09 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Retroalimentaciones]    Script Date: 14/9/2023 03:19:09 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
REFERENCES [dbo].[Eventos] ([EventoID])
GO
/****** Object:  StoredProcedure [dbo].[CrearCuentaAdmin]    Script Date: 14/9/2023 03:19:09 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  StoredProcedure [dbo].[CrearCuentaUsuario]    Script Date: 14/9/2023 03:19:09 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  StoredProcedure [dbo].[CrearEvento]    Script Date: 14/9/2023 03:19:09 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  StoredProcedure [dbo].[EliminarCuenta]    Script Date: 14/9/2023 03:19:09 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  StoredProcedure [dbo].[EncontrarEventosInscritos]    Script Date: 14/9/2023 03:19:09 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  StoredProcedure [dbo].[HacerLogin]    Script Date: 14/9/2023 03:19:09 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  StoredProcedure [dbo].[InscribirEstudianteEvento]    Script Date: 14/9/2023 03:19:09 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  StoredProcedure [dbo].[MostrarColaboradoresDisponibles]    Script Date: 14/9/2023 03:19:09 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  StoredProcedure [dbo].[MostrarEstudiantesInscritos]    Script Date: 14/9/2023 03:19:09 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  StoredProcedure [dbo].[MostrarEventosDisponibles]    Script Date: 14/9/2023 03:19:09 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  StoredProcedure [dbo].[ObtenerDatosEvento]    Script Date: 14/9/2023 03:19:09 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  StoredProcedure [dbo].[ObtenerDatosUsuario]    Script Date: 14/9/2023 03:19:09 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
USE [master]
GO
ALTER DATABASE [UNotify3.8] SET  READ_WRITE 
GO
