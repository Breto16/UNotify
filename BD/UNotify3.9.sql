...
CREATE DATABASE [UNotify3.9]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'UNotify3.9', FILENAME = N'C:\UNotify\UNotify3.9.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'UNotify3.9_log', FILENAME = N'C:\UNotify\UNotify3.9_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
